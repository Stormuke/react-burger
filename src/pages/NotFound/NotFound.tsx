...
export const NotFound: FC<NotFoundProps> = ({ isSmall }) => (
  <div className={styles.body}>
    <div className={styles.container}>
      <svg
        className={classNames(styles.svg, isSmall && styles.svgSmall)}
        width="1123"
        height="837"
      ...
      >
        ...
        <g id="sky" filter="url(#filter0_d)">
          <rect id="background" width="1063" height="777" fill="none" />
    ...
    <div className={styles.text}>
      ...
      <h2>Запуск не удался :(</h2>
      <h3>
        Закончилось топливо <Link to="/">Вернуться в бургерную</Link>
      </h3>
    </div>
  </div>
);
